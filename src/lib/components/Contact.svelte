	...
	<div class="hero-content w-full flex-col lg:flex-row gap-12">
		...
		<div class="w-full">
			...
			<div class="py-6 flex gap-8">
				...
				<a
					href="https://twitter.com/denniskrb_"
					target="_blank"
				...
				<a
					href="https://github.com/denniskribl"
					target="_blank"
					class="btn btn-circle btn-outline btn-secondary"
				>
					<svg
				...
				<a
					href="https://www.linkedin.com/in/denniskribl/"
					target="_blank"
					class="btn btn-circle btn-outline btn-secondary"
				>
					<svg
			...
			<div class="flex justify-center items-center lg:items-start lg:justify-start">
